...
const onKeyDown = (e: KeyboardEvent) => {
    ...
    if (e.key === "ArrowDown") {
        ...
        console.log(
            "selecting",
            results.value[selection.value + windowSelector.value],
            selection.value
        );
        emit("select", results.value[selection.value + windowSelector.value]);
    }
};
    ...
    >
        ...
        <div class="search-results">
            <div
                ...
                @keydown.enter.prevent.stop="emit('select', result)"
                class="song"
                :class="{
                    selected:
